...
class PlazaReportScreen extends StatefulWidget {
  final Map<String, dynamic> event;
  final String reportType;
  const PlazaReportScreen({Key? key, required this.event, required this.reportType}) : super(key: key);

  @override
  State<PlazaReportScreen> createState() => _PlazaReportScreenState();
}

class _PlazaReportScreenState extends State<PlazaReportScreen> {
  ...
  Future<void> _submitReport() async {
    ...
    try {
      ...
      final report = ReportModel(
        ...
        reportedTitle: widget.event['title'] ?? '',
        reportedUser: widget.event['userName'] ?? '',
